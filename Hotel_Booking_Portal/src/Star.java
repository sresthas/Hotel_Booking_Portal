...
public class Star extends JFrame {
	...
	public Star(final String person,final String checkin,final String checkout,final String rooms,final long days) {
		...
		/*Scanner ss=new Scanner("Star.txt");
		int y;
		for(int i=0;i<30;i++)
		{
			String x=ss.next();
		...
		try {
			...
			String sql = "SELECT Rooms FROM StarN ";
			...
			String sql1 = "SELECT Rooms FROM StarD ";
		...
		final int price=(int) (days*8000*roo);
			...
			public void actionPerformed(ActionEvent e) {
				...
				*/
				...
				try {
					...
					int y=i;
					String query="Update StarN set Rooms='"+x+"' where Days='"+y+"'";
				...
				try
				{
					...
					////System.out.println("Day"+i+"="+x);
					int y=i;
					String query="Update StarD set Rooms='"+x+"' where Days='"+y+"'";
					PreparedStatement pst=connection.prepareStatement(query);
					pst.execute();
					pst.close();
					}
				...
				try {
					String query="Update user_data set Hotel='Star' where username='"+person+"'";
					PreparedStatement pst=connection.prepareStatement(query);
					pst.execute();
					pst.close();
					//connection.close();
